...
**项目定位**：端到端 AIoT 开源演示平台。受作者参与的香港智慧充电桩政府项目启发，独立设计构建；同时作为 PolyU *EIE 532 AIoT Technologies* 研究生课程交付物。

**优先级排序**：开源 demo 完成度 > 课程交付物（PPT/视频）。前者追求工程完成度与视觉冲击；后者作为附带产出（10 页正文 + 封面 + 致谢，最后做）。
